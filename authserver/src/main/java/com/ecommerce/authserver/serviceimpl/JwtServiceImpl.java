...
public class JwtServiceImpl implements JwtService{
    ...
    private String createToken(Map<String, Object> claims, String email) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 240))// 4 horas
                .signWith(getSignKey(), SignatureAlgorithm.HS256).compact();  // define o tipo do algoritmo de criptografia //SignatureAlgorithm.HS256
    }
